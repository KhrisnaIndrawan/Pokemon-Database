                ...
                Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewPokemonListResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final pokemons = PokemonGroup.pokemonListCall
                                  .results(
                                    listViewPokemonListResponse.jsonBody,
                                  )
                                  ?.map((e) => e)
                                  .toList()
                                  ?.toList() ??
                              ...
                              return Padding(
                                ...
                                child: FutureBuilder<ApiCallResponse>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final containerPokemonDetailsResponse =
                                        snapshot.data!;
                                    return Container(
                                      width: 100.0,
